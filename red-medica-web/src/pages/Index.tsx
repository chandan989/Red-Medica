          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex items-center justify-between h-20">
              ...
              <nav className="hidden md:flex items-center space-x-8 text-sm font-medium">
                <a href="#problem" className="text-gray-600 hover:text-blue-600 transition-colors duration-300">The Problem</a>
                <a href="#solution" className="text-gray-600 hover:text-blue-600 transition-colors duration-300">Our Solution</a>
                <a href="#howitworks" className="text-gray-600 hover:text-blue-600 transition-colors duration-300">How It Works</a>
            ...
            <div className="container mx-auto px-4 sm:px-6 lg:px-8">
              ...
              <div className="max-w-5xl mx-auto bg-white p-4 sm:p-6 rounded-2xl border border-blue-200 shadow-sm">
                <div className="flex flex-wrap justify-center mb-6">
                  <button className="tab-button active font-semibold py-3 px-5" data-tab="manufacturers">Manufacturers</button>
                  <button className="tab-button font-semibold py-3 px-5" data-tab="distributors">Distributors</button>
                  <button className="tab-button font-semibold py-3 px-5" data-tab="providers">Providers</button>
                  <button className="tab-button font-semibold py-3 px-5" data-tab="patients">Patients</button>
                </div>
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center">
              ...
              <nav className="flex justify-center flex-wrap gap-x-6 gap-y-2 mb-6 text-sm font-medium">
                <a href="#problem" className="text-gray-600 hover:text-blue-600 transition-colors">The Problem</a>
                <a href="#solution" className="text-gray-600 hover:text-blue-600 transition-colors">Our Solution</a>
